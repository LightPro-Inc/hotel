...
public final class MaidDb extends GuidKeyEntityDb<Maid, MaidMetadata> implements Maid {

	private final transient Contact origin;	
	private final Hotel module;
	
	public MaidDb(final Base base, final UUID id, final Hotel module){
		super(base, id, "Personne de chambre introuvable !");
		this.module = module;
	...
	public MaidDayJobs daysJob() throws IOException {
		return hotel().maidDayJobs().of(this);
	}
}
